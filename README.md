...
| **Blockive Blockquote** | A styled quotation with its author and a share-on-X button. | Border, quotation mark, boxed, or clean skin; alignment; X share with the quote, author, and page link; typography and colors. |
